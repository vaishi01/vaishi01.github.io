...
export const Wallet: IconComponent<WalletProps> = React.forwardRef<
  SVGSVGElement,
  WalletProps
>(function Wallet(
  {
  ...
  console.error(`Wallet doesn't support ${type}`);
  return null;
});
...
Wallet.metadata = {
  ...
  tags: ["wallet", "icon"],
  description: "Wallet icon from stroke/finance category",
  type: ["stroke", "icon"],
} as IconMetadata;
