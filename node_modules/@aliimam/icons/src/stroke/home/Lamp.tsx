...
export const Lamp: IconComponent = React.forwardRef<SVGSVGElement, IconProps>(
  function Lamp(
    {
      color = "currentColor",
      fill,
...
Lamp.metadata = {
  ...
  tags: ["lamp", "icon"],
  description: "Lamp icon from stroke/home category",
  type: ["stroke", "icon"],
} as IconMetadata;
