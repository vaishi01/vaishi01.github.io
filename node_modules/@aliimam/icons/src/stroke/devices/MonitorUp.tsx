...
interface MonitorUpProps extends IconProps {
  type?: "stroke";
}

export const MonitorUp: IconComponent<MonitorUpProps> = React.forwardRef<
  SVGSVGElement,
  MonitorUpProps
>(function MonitorUp(
  {
  ...
  console.error(`MonitorUp doesn't support ${type}`);
  return null;
});
...
MonitorUp.metadata = {
  ...
  description: "MonitorUp icon from stroke/devices category",
  type: ["stroke", "icon"],
} as IconMetadata;
