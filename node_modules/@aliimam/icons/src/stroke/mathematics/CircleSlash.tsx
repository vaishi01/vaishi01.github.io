...
interface CircleSlashProps extends IconProps {
  type?: "stroke";
}

export const CircleSlash: IconComponent<CircleSlashProps> = React.forwardRef<
  SVGSVGElement,
  CircleSlashProps
>(function CircleSlash(
  ...
  console.error(`CircleSlash doesn't support ${type}`);
  return null;
});
...
CircleSlash.metadata = {
  ...
  description: "CircleSlash icon from stroke/mathematics category",
  type: ["stroke", "icon"],
} as IconMetadata;
