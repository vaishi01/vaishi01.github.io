...
export const PanelBottom: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
...
PanelBottom.metadata = {
  name: "PanelBottom",
  category: "stroke/layout",
  tags: ["panel", "bottom", "icon"],
  description: "PanelBottom icon from stroke/layout category",
  type: ["stroke", "icon"],
} as IconMetadata;
