...
interface PanelBottomCloseProps extends IconProps {
  type?: "stroke";
}

export const PanelBottomClose: IconComponent<PanelBottomCloseProps> =
  React.forwardRef<SVGSVGElement, PanelBottomCloseProps>(
    function PanelBottomClose(
      ...
      console.error(`PanelBottomClose doesn't support ${type}`);
      return null;
    },
  );
...
PanelBottomClose.metadata = {
  ...
  description: "PanelBottomClose icon from stroke/layout category",
  type: ["stroke", "icon"],
} as IconMetadata;
