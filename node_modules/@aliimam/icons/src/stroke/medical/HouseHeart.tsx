...
interface HouseHeartProps extends IconProps {
  type?: "stroke";
}

export const HouseHeart: IconComponent<HouseHeartProps> = React.forwardRef<
  SVGSVGElement,
  HouseHeartProps
>(function HouseHeart(
  {
