...
export const ThermometerSnowflake: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function ThermometerSnowflake(
  {
    color = "currentColor",
    fill,
    size = 24,
