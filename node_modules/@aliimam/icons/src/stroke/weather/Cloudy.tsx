...
export const Cloudy: IconComponent = React.forwardRef<SVGSVGElement, IconProps>(
  function Cloudy(
    {
      color = "currentColor",
      fill,
...
Cloudy.metadata = {
  ...
  tags: ["cloudy", "icon"],
  description: "Cloudy icon from stroke/weather category",
  type: ["stroke", "icon"],
} as IconMetadata;
