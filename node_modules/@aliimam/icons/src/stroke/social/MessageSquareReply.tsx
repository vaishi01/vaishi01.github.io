...
export const MessageSquareReply: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function MessageSquareReply(
  {
    color = "currentColor",
    fill,
    size = 24,
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M17 14V13C17 12.4696 16.7893 11.9609 16.4142 11.5858C16.0391 11.2107 15.5304 11 15 11H7"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
MessageSquareReply.metadata = {
  name: "MessageSquareReply",
  category: "stroke/social",
  tags: ["message", "square", "reply", "icon"],
  description: "MessageSquareReply icon from stroke/social category",
  type: ["stroke", "icon"],
} as IconMetadata;
