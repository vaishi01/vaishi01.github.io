...
export const MessageSquareX: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function MessageSquareX(
  {
    color = "currentColor",
    fill,
    size = 24,
...
MessageSquareX.metadata = {
  name: "MessageSquareX",
  category: "stroke/social",
  tags: ["message", "square", "icon"],
  description: "MessageSquareX icon from stroke/social category",
  type: ["stroke", "icon"],
} as IconMetadata;
