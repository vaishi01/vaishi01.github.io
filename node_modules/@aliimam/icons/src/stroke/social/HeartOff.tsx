...
interface HeartOffProps extends IconProps {
  type?: "stroke";
}

export const HeartOff: IconComponent<HeartOffProps> = React.forwardRef<
  SVGSVGElement,
  HeartOffProps
>(function HeartOff(
  {
  ...
  console.error(`HeartOff doesn't support ${type}`);
  return null;
});
...
HeartOff.metadata = {
  ...
  tags: ["heart", "off", "icon"],
  description: "HeartOff icon from stroke/social category",
  type: ["stroke", "icon"],
} as IconMetadata;
