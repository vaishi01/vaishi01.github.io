...
export const MessageCirclePlus: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function MessageCirclePlus(
  {
    color = "currentColor",
    fill,
    size = 24,
...
MessageCirclePlus.metadata = {
  name: "MessageCirclePlus",
  category: "stroke/social",
  tags: ["message", "circle", "plus", "icon"],
  description: "MessageCirclePlus icon from stroke/social category",
  type: ["stroke", "icon"],
} as IconMetadata;
