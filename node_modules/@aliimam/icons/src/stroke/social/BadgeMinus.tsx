...
export const BadgeMinus: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function BadgeMinus(
  {
...
BadgeMinus.metadata = {
  ...
  tags: ["badge", "minus", "icon"],
  description: "BadgeMinus icon from stroke/social category",
  type: ["stroke", "icon"],
} as IconMetadata;
