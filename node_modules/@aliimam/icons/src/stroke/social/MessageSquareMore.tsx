...
export const MessageSquareMore: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function MessageSquareMore(
  {
    color = "currentColor",
    fill,
    size = 24,
...
MessageSquareMore.metadata = {
  name: "MessageSquareMore",
  category: "stroke/social",
  tags: ["message", "square", "more", "icon"],
  description: "MessageSquareMore icon from stroke/social category",
  type: ["stroke", "icon"],
} as IconMetadata;
