...
interface SlackProps extends IconProps {
  type?: "stroke";
}

export const Slack: IconComponent<SlackProps> = React.forwardRef<
  SVGSVGElement,
  SlackProps
>(function Slack(
  {
  ...
  console.error(`Slack doesn't support ${type}`);
  return null;
});
...
Slack.metadata = {
  ...
  tags: ["slack", "icon"],
  description: "Slack icon from stroke/social category",
  type: ["stroke", "icon"],
} as IconMetadata;
