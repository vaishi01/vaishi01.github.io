...
export const BadgeX: IconComponent = React.forwardRef<SVGSVGElement, IconProps>(
  function BadgeX(
    {
      color = "currentColor",
      fill,
...
BadgeX.metadata = {
  ...
  tags: ["badge", "icon"],
  description: "BadgeX icon from stroke/social category",
  type: ["stroke", "icon"],
} as IconMetadata;
