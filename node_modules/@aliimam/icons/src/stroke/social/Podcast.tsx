...
interface PodcastProps extends IconProps {
  type?: "stroke";
}

export const Podcast: IconComponent<PodcastProps> = React.forwardRef<
  SVGSVGElement,
  PodcastProps
>(function Podcast(
  {
  ...
  console.error(`Podcast doesn't support ${type}`);
  return null;
});
...
Podcast.metadata = {
  ...
  tags: ["podcast", "icon"],
  description: "Podcast icon from stroke/social category",
  type: ["stroke", "icon"],
} as IconMetadata;
