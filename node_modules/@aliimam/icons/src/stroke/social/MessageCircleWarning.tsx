...
interface MessageCircleWarningProps extends IconProps {
  type?: "stroke";
}

export const MessageCircleWarning: IconComponent<MessageCircleWarningProps> =
  React.forwardRef<SVGSVGElement, MessageCircleWarningProps>(
    function MessageCircleWarning(
      ...
      console.error(`MessageCircleWarning doesn't support ${type}`);
      return null;
    },
  );
...
MessageCircleWarning.metadata = {
  ...
  description: "MessageCircleWarning icon from stroke/social category",
  type: ["stroke", "icon"],
} as IconMetadata;
