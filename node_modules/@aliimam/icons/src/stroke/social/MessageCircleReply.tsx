...
export const MessageCircleReply: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function MessageCircleReply(
  {
    color = "currentColor",
    fill,
    size = 24,
...
MessageCircleReply.metadata = {
  name: "MessageCircleReply",
  category: "stroke/social",
  tags: ["message", "circle", "reply", "icon"],
  description: "MessageCircleReply icon from stroke/social category",
  type: ["stroke", "icon"],
} as IconMetadata;
