...
export const BadgePlus: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function BadgePlus(
  {
...
BadgePlus.metadata = {
  ...
  tags: ["badge", "plus", "icon"],
  description: "BadgePlus icon from stroke/social category",
  type: ["stroke", "icon"],
} as IconMetadata;
