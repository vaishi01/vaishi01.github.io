...
export const MessageCircleQuestionMark: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function MessageCircleQuestionMark(
  {
    color = "currentColor",
    fill,
    size = 24,
...
MessageCircleQuestionMark.metadata = {
  name: "MessageCircleQuestionMark",
  category: "stroke/social",
  tags: ["message", "circle", "question", "mark", "icon"],
  description: "MessageCircleQuestionMark icon from stroke/social category",
  type: ["stroke", "icon"],
} as IconMetadata;
