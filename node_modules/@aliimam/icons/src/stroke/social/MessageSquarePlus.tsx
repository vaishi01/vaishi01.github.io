...
export const MessageSquarePlus: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function MessageSquarePlus(
  {
    color = "currentColor",
    fill,
    size = 24,
...
MessageSquarePlus.metadata = {
  name: "MessageSquarePlus",
  category: "stroke/social",
  tags: ["message", "square", "plus", "icon"],
  description: "MessageSquarePlus icon from stroke/social category",
  type: ["stroke", "icon"],
} as IconMetadata;
