...
export const MailWarning: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function MailWarning(
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M22 7 13.03 12.7C12.721 12.893 12.364 12.996 12 12.996 11.636 12.996 11.279 12.893 10.97 12.7L2 7M20 14V18M20 22V22.01"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
MailWarning.metadata = {
  name: "MailWarning",
  category: "stroke/mail",
  tags: ["mail", "warning", "icon"],
  description: "MailWarning icon from stroke/mail category",
  type: ["stroke", "icon"],
} as IconMetadata;
