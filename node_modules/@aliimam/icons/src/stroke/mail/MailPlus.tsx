...
export const MailPlus: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function MailPlus(
  {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M22 7 13.03 12.7C12.721 12.893 12.364 12.996 12 12.996 11.636 12.996 11.279 12.893 10.97 12.7L2 7M19 16V22M16 19H22"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
MailPlus.metadata = {
  ...
  tags: ["mail", "plus", "icon"],
  description: "MailPlus icon from stroke/mail category",
  type: ["stroke", "icon"],
} as IconMetadata;
