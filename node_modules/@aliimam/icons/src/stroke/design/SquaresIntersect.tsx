...
export const SquaresIntersect: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function SquaresIntersect(
  {
    color = "currentColor",
    fill,
    size = 24,
...
SquaresIntersect.metadata = {
  name: "SquaresIntersect",
  category: "stroke/design",
  tags: ["squares", "intersect", "icon"],
  description: "SquaresIntersect icon from stroke/design category",
  type: ["stroke", "icon"],
} as IconMetadata;
