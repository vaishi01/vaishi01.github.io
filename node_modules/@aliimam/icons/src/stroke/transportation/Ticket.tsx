...
interface TicketProps extends IconProps {
  type?: "stroke";
}

export const Ticket: IconComponent<TicketProps> = React.forwardRef<
  SVGSVGElement,
  TicketProps
>(function Ticket(
  {
  ...
  console.error(`Ticket doesn't support ${type}`);
  return null;
});
...
Ticket.metadata = {
  ...
  tags: ["ticket", "icon"],
  description: "Ticket icon from stroke/transportation category",
  type: ["stroke", "icon"],
} as IconMetadata;
