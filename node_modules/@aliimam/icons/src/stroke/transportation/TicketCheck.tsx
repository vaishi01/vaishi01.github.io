...
export const TicketCheck: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
...
TicketCheck.metadata = {
  name: "TicketCheck",
  category: "stroke/transportation",
  tags: ["ticket", "check", "icon"],
  description: "TicketCheck icon from stroke/transportation category",
  type: ["stroke", "icon"],
} as IconMetadata;
