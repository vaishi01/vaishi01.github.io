...
interface CircleParkingProps extends IconProps {
  type?: "stroke";
}

export const CircleParking: IconComponent<CircleParkingProps> =
  React.forwardRef<SVGSVGElement, CircleParkingProps>(function CircleParking(
    {
      color = "currentColor",
      fill,
      size = 24,
