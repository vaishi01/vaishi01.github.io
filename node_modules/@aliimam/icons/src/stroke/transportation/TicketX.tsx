...
export const TicketX: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function TicketX(
  {
...
TicketX.metadata = {
  ...
  tags: ["ticket", "icon"],
  description: "TicketX icon from stroke/transportation category",
  type: ["stroke", "icon"],
} as IconMetadata;
