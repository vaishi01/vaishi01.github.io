...
export const TicketSlash: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function TicketSlash(
  {
    color = "currentColor",
    fill,
    size = 24,
...
TicketSlash.metadata = {
  name: "TicketSlash",
  category: "stroke/transportation",
  tags: ["ticket", "slash", "icon"],
  description: "TicketSlash icon from stroke/transportation category",
  type: ["stroke", "icon"],
} as IconMetadata;
