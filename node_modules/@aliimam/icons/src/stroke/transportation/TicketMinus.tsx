...
export const TicketMinus: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
...
TicketMinus.metadata = {
  name: "TicketMinus",
  category: "stroke/transportation",
  tags: ["ticket", "minus", "icon"],
  description: "TicketMinus icon from stroke/transportation category",
  type: ["stroke", "icon"],
} as IconMetadata;
