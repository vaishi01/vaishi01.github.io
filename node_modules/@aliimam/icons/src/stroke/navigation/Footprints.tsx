...
export const Footprints: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Footprints(
  {
...
Footprints.metadata = {
  ...
  tags: ["footprints", "icon"],
  description: "Footprints icon from stroke/navigation category",
  type: ["stroke", "icon"],
} as IconMetadata;
