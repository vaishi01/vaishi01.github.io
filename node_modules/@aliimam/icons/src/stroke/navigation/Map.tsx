...
interface MapProps extends IconProps {
  type?: "stroke";
}

export const Map: IconComponent<MapProps> = React.forwardRef<
  SVGSVGElement,
  MapProps
>(function Map(
  {
  ...
  console.error(`Map doesn't support ${type}`);
  return null;
});
...
Map.metadata = {
  ...
  tags: ["map", "icon"],
  description: "Map icon from stroke/navigation category",
  type: ["stroke", "icon"],
} as IconMetadata;
