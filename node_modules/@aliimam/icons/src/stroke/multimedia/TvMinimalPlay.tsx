...
interface TvMinimalPlayProps extends IconProps {
  type?: "stroke";
}

export const TvMinimalPlay: IconComponent<TvMinimalPlayProps> =
  React.forwardRef<SVGSVGElement, TvMinimalPlayProps>(function TvMinimalPlay(
    {
      color = "currentColor",
      fill,
      size = 24,
    ...
    console.error(`TvMinimalPlay doesn't support ${type}`);
    return null;
  });
...
TvMinimalPlay.metadata = {
  ...
  description: "TvMinimalPlay icon from stroke/multimedia category",
  type: ["stroke", "icon"],
} as IconMetadata;
