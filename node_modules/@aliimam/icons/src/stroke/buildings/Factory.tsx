...
export const Factory: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Factory(
  {
...
Factory.metadata = {
  ...
  tags: ["factory", "icon"],
  description: "Factory icon from stroke/buildings category",
  type: ["stroke", "icon"],
} as IconMetadata;
