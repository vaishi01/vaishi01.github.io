...
export const BeanOff: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function BeanOff(
  {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M5.341 10.62C5.604 11.214 6.008 11.735 6.518 12.138 7.027 12.541 7.627 12.814 8.266 12.933 8.905 13.052 9.563 13.014 10.184 12.821 10.804 12.628 11.369 12.288 11.828 11.828M10.62 5.341C11.529 5.745 12.256 6.472 12.659 7.381M2 2 22 22"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
BeanOff.metadata = {
  ...
  tags: ["bean", "off", "icon"],
  description: "BeanOff icon from stroke/foodBeverage category",
  type: ["stroke", "icon"],
} as IconMetadata;
