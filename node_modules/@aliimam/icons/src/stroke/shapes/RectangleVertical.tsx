...
interface RectangleVerticalProps extends IconProps {
  type?: "stroke";
}

export const RectangleVertical: IconComponent<RectangleVerticalProps> =
  React.forwardRef<SVGSVGElement, RectangleVerticalProps>(
