...
interface SpadeProps extends IconProps {
  type?: "stroke";
}

export const Spade: IconComponent<SpadeProps> = React.forwardRef<
  SVGSVGElement,
  SpadeProps
>(function Spade(
  {
