...
interface HexagonProps extends IconProps {
  type?: "stroke";
}

export const Hexagon: IconComponent<HexagonProps> = React.forwardRef<
  SVGSVGElement,
  HexagonProps
>(function Hexagon(
  {
  ...
  console.error(`Hexagon doesn't support ${type}`);
  return null;
});
...
Hexagon.metadata = {
  ...
  tags: ["hexagon", "icon"],
  description: "Hexagon icon from stroke/shapes category",
  type: ["stroke", "icon"],
} as IconMetadata;
