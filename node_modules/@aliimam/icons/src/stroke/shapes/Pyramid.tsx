...
interface PyramidProps extends IconProps {
  type?: "stroke";
}

export const Pyramid: IconComponent<PyramidProps> = React.forwardRef<
  SVGSVGElement,
  PyramidProps
>(function Pyramid(
  {
