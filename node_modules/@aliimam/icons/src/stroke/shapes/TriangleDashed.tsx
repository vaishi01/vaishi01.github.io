...
export const TriangleDashed: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function TriangleDashed(
  {
    color = "currentColor",
    fill,
    size = 24,
