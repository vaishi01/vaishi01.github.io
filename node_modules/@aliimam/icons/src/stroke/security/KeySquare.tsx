...
interface KeySquareProps extends IconProps {
  type?: "stroke";
}

export const KeySquare: IconComponent<KeySquareProps> = React.forwardRef<
  SVGSVGElement,
  KeySquareProps
>(function KeySquare(
  {
