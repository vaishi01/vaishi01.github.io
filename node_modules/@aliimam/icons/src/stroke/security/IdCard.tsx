...
interface IdCardProps extends IconProps {
  type?: "stroke";
}

export const IdCard: IconComponent<IdCardProps> = React.forwardRef<
  SVGSVGElement,
  IdCardProps
>(function IdCard(
  {
  ...
  console.error(`IdCard doesn't support ${type}`);
  return null;
});
...
IdCard.metadata = {
  ...
  tags: ["id", "card", "icon"],
  description: "IdCard icon from stroke/security category",
  type: ["stroke", "icon"],
} as IconMetadata;
