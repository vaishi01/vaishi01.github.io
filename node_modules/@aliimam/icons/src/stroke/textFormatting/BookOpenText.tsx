...
interface BookOpenTextProps extends IconProps {
  type?: "stroke";
}

export const BookOpenText: IconComponent<BookOpenTextProps> = React.forwardRef<
  SVGSVGElement,
  BookOpenTextProps
>(function BookOpenText(
  ...
  console.error(`BookOpenText doesn't support ${type}`);
  return null;
});
...
BookOpenText.metadata = {
  ...
  description: "BookOpenText icon from stroke/textFormatting category",
  type: ["stroke", "icon"],
} as IconMetadata;
