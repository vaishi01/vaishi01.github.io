...
export const ClipboardPen: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function ClipboardPen(
  {
    color = "currentColor",
    fill,
    size = 24,
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M16 4H18C18.53 4 19.039 4.211 19.414 4.586 19.789 4.961 20 5.47 20 6V20C20 20.53 19.789 21.039 19.414 21.414 19.039 21.789 18.53 22 18 22H12.5M4 13.5V6C4 5.47 4.211 4.961 4.586 4.586 4.961 4.211 5.47 4 6 4H8"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
ClipboardPen.metadata = {
  name: "ClipboardPen",
  category: "stroke/textFormatting",
  tags: ["clipboard", "pen", "icon"],
  description: "ClipboardPen icon from stroke/textFormatting category",
  type: ["stroke", "icon"],
} as IconMetadata;
