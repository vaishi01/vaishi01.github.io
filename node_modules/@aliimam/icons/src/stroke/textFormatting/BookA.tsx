...
interface BookAProps extends IconProps {
  type?: "stroke";
}

export const BookA: IconComponent<BookAProps> = React.forwardRef<
  SVGSVGElement,
  BookAProps
>(function BookA(
  {
  ...
  console.error(`BookA doesn't support ${type}`);
  return null;
});
...
BookA.metadata = {
  ...
  tags: ["book", "icon"],
  description: "BookA icon from stroke/textFormatting category",
  type: ["stroke", "icon"],
} as IconMetadata;
