...
interface Table2Props extends IconProps {
  type?: "stroke";
}

export const Table2: IconComponent<Table2Props> = React.forwardRef<
  SVGSVGElement,
  Table2Props
>(function Table2(
  {
  ...
  console.error(`Table2 doesn't support ${type}`);
  return null;
});
...
Table2.metadata = {
  ...
  tags: ["table", "icon"],
  description: "Table2 icon from stroke/textFormatting category",
  type: ["stroke", "icon"],
} as IconMetadata;
