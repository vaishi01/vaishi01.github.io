...
interface BoltProps extends IconProps {
  type?: "stroke";
}

export const Bolt: IconComponent<BoltProps> = React.forwardRef<
  SVGSVGElement,
  BoltProps
>(function Bolt(
  {
  ...
  console.error(`Bolt doesn't support ${type}`);
  return null;
});
...
Bolt.metadata = {
  ...
  tags: ["bolt", "icon"],
  description: "Bolt icon from stroke/tools category",
  type: ["stroke", "icon"],
} as IconMetadata;
