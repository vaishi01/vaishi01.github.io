...
export const BookUp: IconComponent = React.forwardRef<SVGSVGElement, IconProps>(
  function BookUp(
    {
      color = "currentColor",
      fill,
...
BookUp.metadata = {
  ...
  tags: ["book", "up", "icon"],
  description: "BookUp icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
