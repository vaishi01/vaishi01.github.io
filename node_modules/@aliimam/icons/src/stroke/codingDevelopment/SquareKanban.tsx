...
interface SquareKanbanProps extends IconProps {
  type?: "stroke";
}

export const SquareKanban: IconComponent<SquareKanbanProps> = React.forwardRef<
  SVGSVGElement,
  SquareKanbanProps
>(function SquareKanban(
  ...
  console.error(`SquareKanban doesn't support ${type}`);
  return null;
});
...
SquareKanban.metadata = {
  ...
  description: "SquareKanban icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
