...
export const PackagePlus: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function PackagePlus(
  {
    color = "currentColor",
    fill,
    size = 24,
...
PackagePlus.metadata = {
  name: "PackagePlus",
  category: "stroke/codingDevelopment",
  tags: ["package", "plus", "icon"],
  description: "PackagePlus icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
