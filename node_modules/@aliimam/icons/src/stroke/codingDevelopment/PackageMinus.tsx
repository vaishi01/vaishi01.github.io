...
export const PackageMinus: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function PackageMinus(
  {
    color = "currentColor",
    fill,
    size = 24,
...
PackageMinus.metadata = {
  name: "PackageMinus",
  category: "stroke/codingDevelopment",
  tags: ["package", "minus", "icon"],
  description: "PackageMinus icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
