...
export const PackageX: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function PackageX(
  {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M3.29 7 12 12 20.71 7M12 22V12M17 13 22 18M17 18 22 13"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
PackageX.metadata = {
  ...
  tags: ["package", "icon"],
  description: "PackageX icon from stroke/codingDevelopment category",
  type: ["stroke", "icon"],
} as IconMetadata;
