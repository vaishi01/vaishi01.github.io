...
interface FileAxis3DProps extends IconProps {
  type?: "stroke";
}

export const FileAxis3D: IconComponent<FileAxis3DProps> = React.forwardRef<
  SVGSVGElement,
  FileAxis3DProps
>(function FileAxis3D(
  {
  ...
  console.error(`FileAxis3D doesn't support ${type}`);
  return null;
});
...
FileAxis3D.metadata = {
  ...
  tags: ["file", "axis", "icon"],
  description: "FileAxis3D icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
