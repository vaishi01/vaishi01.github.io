...
export const FileMinus2: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FileMinus2(
  {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M3 15H9"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
FileMinus2.metadata = {
  ...
  tags: ["file", "minus", "icon"],
  description: "FileMinus2 icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
