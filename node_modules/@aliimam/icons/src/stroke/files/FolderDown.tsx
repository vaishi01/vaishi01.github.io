...
interface FolderDownProps extends IconProps {
  type?: "stroke";
}

export const FolderDown: IconComponent<FolderDownProps> = React.forwardRef<
  SVGSVGElement,
  FolderDownProps
>(function FolderDown(
  {
  ...
  console.error(`FolderDown doesn't support ${type}`);
  return null;
});
...
FolderDown.metadata = {
  ...
  description: "FolderDown icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
