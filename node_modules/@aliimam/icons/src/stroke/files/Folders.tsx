...
export const Folders: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function Folders(
  {
...
Folders.metadata = {
  ...
  tags: ["folders", "icon"],
  description: "Folders icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
