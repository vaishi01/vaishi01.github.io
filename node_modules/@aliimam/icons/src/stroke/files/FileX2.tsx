...
export const FileX2: IconComponent = React.forwardRef<SVGSVGElement, IconProps>(
  function FileX2(
    {
      color = "currentColor",
      fill,
    ...
    return (
      ...
      >
        ...
        />
        <path
          d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M8 12.5 3 17.5M3 12.5 8 17.5"
          stroke={color}
          strokeLinecap="round"
          strokeLinejoin="round"
        />
...
FileX2.metadata = {
  ...
  tags: ["file", "icon"],
  description: "FileX2 icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
