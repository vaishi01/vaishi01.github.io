...
export const FilePlus: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FilePlus(
  {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M9 15H15M12 18V12"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
FilePlus.metadata = {
  ...
  tags: ["file", "plus", "icon"],
  description: "FilePlus icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
