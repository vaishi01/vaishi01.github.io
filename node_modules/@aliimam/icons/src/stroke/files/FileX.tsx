...
export const FileX: IconComponent = React.forwardRef<SVGSVGElement, IconProps>(
  function FileX(
    {
      color = "currentColor",
      fill,
    ...
    return (
      ...
      >
        ...
        />
        <path
          d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M14.5 12.5 9.5 17.5M9.5 12.5 14.5 17.5"
          stroke={color}
          strokeLinecap="round"
          strokeLinejoin="round"
        />
...
FileX.metadata = {
  ...
  tags: ["file", "icon"],
  description: "FileX icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
