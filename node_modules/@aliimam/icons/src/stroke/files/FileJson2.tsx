...
interface FileJson2Props extends IconProps {
  type?: "stroke";
}

export const FileJson2: IconComponent<FileJson2Props> = React.forwardRef<
  SVGSVGElement,
  FileJson2Props
>(function FileJson2(
  {
  ...
  console.error(`FileJson2 doesn't support ${type}`);
  return null;
});
...
FileJson2.metadata = {
  ...
  tags: ["file", "json", "icon"],
  description: "FileJson2 icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
