...
interface FolderRootProps extends IconProps {
  type?: "stroke";
}

export const FolderRoot: IconComponent<FolderRootProps> = React.forwardRef<
  SVGSVGElement,
  FolderRootProps
>(function FolderRoot(
  {
  ...
  console.error(`FolderRoot doesn't support ${type}`);
  return null;
});
...
FolderRoot.metadata = {
  ...
  description: "FolderRoot icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
