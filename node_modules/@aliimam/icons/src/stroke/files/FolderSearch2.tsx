...
export const FolderSearch2: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FolderSearch2(
  {
    color = "currentColor",
    fill,
    size = 24,
...
FolderSearch2.metadata = {
  name: "FolderSearch2",
  category: "stroke/files",
  tags: ["folder", "search", "icon"],
  description: "FolderSearch2 icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
