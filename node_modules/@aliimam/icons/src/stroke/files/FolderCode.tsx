...
interface FolderCodeProps extends IconProps {
  type?: "stroke";
}

export const FolderCode: IconComponent<FolderCodeProps> = React.forwardRef<
  SVGSVGElement,
  FolderCodeProps
>(function FolderCode(
  {
  ...
  console.error(`FolderCode doesn't support ${type}`);
  return null;
});
...
FolderCode.metadata = {
  ...
  description: "FolderCode icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
