...
interface FileUpProps extends IconProps {
  type?: "stroke";
}

export const FileUp: IconComponent<FileUpProps> = React.forwardRef<
  SVGSVGElement,
  FileUpProps
>(function FileUp(
  {
  ...
  console.error(`FileUp doesn't support ${type}`);
  return null;
});
...
FileUp.metadata = {
  ...
  tags: ["file", "up", "icon"],
  description: "FileUp icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
