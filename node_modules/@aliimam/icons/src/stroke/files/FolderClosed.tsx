...
export const FolderClosed: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
...
FolderClosed.metadata = {
  name: "FolderClosed",
  category: "stroke/files",
  tags: ["folder", "closed", "icon"],
  description: "FolderClosed icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
