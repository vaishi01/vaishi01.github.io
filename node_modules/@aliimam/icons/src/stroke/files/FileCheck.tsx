...
export const FileCheck: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FileCheck(
  {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M9 15 11 17 15 13"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
FileCheck.metadata = {
  ...
  tags: ["file", "check", "icon"],
  description: "FileCheck icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
