...
export const FileChartColumnIncreasing: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FileChartColumnIncreasing(
  {
    color = "currentColor",
    fill,
    size = 24,
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M8 18V16M12 18V14M16 18V12"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
FileChartColumnIncreasing.metadata = {
  name: "FileChartColumnIncreasing",
  category: "stroke/files",
  tags: ["file", "chart", "column", "increasing", "icon"],
  description: "FileChartColumnIncreasing icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
