...
interface FileDownProps extends IconProps {
  type?: "stroke";
}

export const FileDown: IconComponent<FileDownProps> = React.forwardRef<
  SVGSVGElement,
  FileDownProps
>(function FileDown(
  {
  ...
  console.error(`FileDown doesn't support ${type}`);
  return null;
});
...
FileDown.metadata = {
  ...
  tags: ["file", "down", "icon"],
  description: "FileDown icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
