...
export const FileSpreadsheet: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FileSpreadsheet(
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M8 13H10M14 13H16M8 17H10M14 17H16"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
FileSpreadsheet.metadata = {
  name: "FileSpreadsheet",
  category: "stroke/files",
  tags: ["file", "spreadsheet", "icon"],
  description: "FileSpreadsheet icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
