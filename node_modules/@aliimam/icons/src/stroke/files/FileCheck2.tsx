...
export const FileCheck2: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FileCheck2(
  {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M3 15 5 17 9 13"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
FileCheck2.metadata = {
  ...
  description: "FileCheck2 icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
