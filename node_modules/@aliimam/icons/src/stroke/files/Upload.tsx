...
export const Upload: IconComponent<UploadProps> = React.forwardRef<
  SVGSVGElement,
  UploadProps
>(function Upload(
  {
  ...
  console.error(`Upload doesn't support ${type}`);
  return null;
});
...
Upload.metadata = {
  ...
  tags: ["upload", "icon"],
  description: "Upload icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
