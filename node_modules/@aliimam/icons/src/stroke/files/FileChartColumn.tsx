...
export const FileChartColumn: IconComponent = React.forwardRef<
  SVGSVGElement,
  IconProps
>(function FileChartColumn(
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M14 2V6C14 6.53 14.211 7.039 14.586 7.414 14.961 7.789 15.47 8 16 8H20M8 18V17M12 18V12M16 18V15"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
FileChartColumn.metadata = {
  name: "FileChartColumn",
  category: "stroke/files",
  tags: ["file", "chart", "column", "icon"],
  description: "FileChartColumn icon from stroke/files category",
  type: ["stroke", "icon"],
} as IconMetadata;
