...
interface BadgeTurkishLiraProps extends IconProps {
  type?: "stroke";
}

export const BadgeTurkishLira: IconComponent<BadgeTurkishLiraProps> =
  React.forwardRef<SVGSVGElement, BadgeTurkishLiraProps>(
    function BadgeTurkishLira(
      ...
      console.error(`BadgeTurkishLira doesn't support ${type}`);
      return null;
    },
  );
...
BadgeTurkishLira.metadata = {
  ...
  description: "BadgeTurkishLira icon from stroke/shopping category",
  type: ["stroke", "icon"],
} as IconMetadata;
