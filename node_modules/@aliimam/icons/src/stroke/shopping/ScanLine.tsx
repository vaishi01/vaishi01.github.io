...
interface ScanLineProps extends IconProps {
  type?: "stroke";
}

export const ScanLine: IconComponent<ScanLineProps> = React.forwardRef<
  SVGSVGElement,
  ScanLineProps
>(function ScanLine(
  {
  ...
  console.error(`ScanLine doesn't support ${type}`);
  return null;
});
...
ScanLine.metadata = {
  ...
  tags: ["scan", "line", "icon"],
  description: "ScanLine icon from stroke/shopping category",
  type: ["stroke", "icon"],
} as IconMetadata;
