...
interface BadgeEuroProps extends IconProps {
  type?: "stroke";
}

export const BadgeEuro: IconComponent<BadgeEuroProps> = React.forwardRef<
  SVGSVGElement,
  BadgeEuroProps
>(function BadgeEuro(
  {
  ...
  console.error(`BadgeEuro doesn't support ${type}`);
  return null;
});
...
BadgeEuro.metadata = {
  ...
  description: "BadgeEuro icon from stroke/shopping category",
  type: ["stroke", "icon"],
} as IconMetadata;
