...
interface BadgeDollarSignProps extends IconProps {
  type?: "stroke";
}

export const BadgeDollarSign: IconComponent<BadgeDollarSignProps> =
  React.forwardRef<SVGSVGElement, BadgeDollarSignProps>(
    function BadgeDollarSign(
      ...
      console.error(`BadgeDollarSign doesn't support ${type}`);
      return null;
    },
  );
...
BadgeDollarSign.metadata = {
  ...
  description: "BadgeDollarSign icon from stroke/shopping category",
  type: ["stroke", "icon"],
} as IconMetadata;
