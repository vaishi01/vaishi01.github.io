...
interface BadgeIndianRupeeProps extends IconProps {
  type?: "stroke";
}

export const BadgeIndianRupee: IconComponent<BadgeIndianRupeeProps> =
  React.forwardRef<SVGSVGElement, BadgeIndianRupeeProps>(
    function BadgeIndianRupee(
      ...
      console.error(`BadgeIndianRupee doesn't support ${type}`);
      return null;
    },
  );
...
BadgeIndianRupee.metadata = {
  ...
  description: "BadgeIndianRupee icon from stroke/shopping category",
  type: ["stroke", "icon"],
} as IconMetadata;
