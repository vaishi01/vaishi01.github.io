...
interface BadgeRussianRubleProps extends IconProps {
  type?: "stroke";
}

export const BadgeRussianRuble: IconComponent<BadgeRussianRubleProps> =
  React.forwardRef<SVGSVGElement, BadgeRussianRubleProps>(
