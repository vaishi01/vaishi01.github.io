...
interface TicketPercentProps extends IconProps {
  type?: "stroke";
}

export const TicketPercent: IconComponent<TicketPercentProps> =
  React.forwardRef<SVGSVGElement, TicketPercentProps>(function TicketPercent(
    {
      color = "currentColor",
      fill,
      size = 24,
    ...
    console.error(`TicketPercent doesn't support ${type}`);
    return null;
  });

TicketPercent.displayName = "TicketPercent";

TicketPercent.metadata = {
  name: "TicketPercent",
  category: "stroke/shopping",
  tags: ["ticket", "percent", "icon"],
  description: "TicketPercent icon from stroke/shopping category",
  type: ["stroke", "icon"],
} as IconMetadata;
