...
interface BadgeJapaneseYenProps extends IconProps {
  type?: "stroke";
}

export const BadgeJapaneseYen: IconComponent<BadgeJapaneseYenProps> =
  React.forwardRef<SVGSVGElement, BadgeJapaneseYenProps>(
    function BadgeJapaneseYen(
      ...
      console.error(`BadgeJapaneseYen doesn't support ${type}`);
      return null;
    },
  );
...
BadgeJapaneseYen.metadata = {
  ...
  description: "BadgeJapaneseYen icon from stroke/shopping category",
  type: ["stroke", "icon"],
} as IconMetadata;
