...
interface BadgePoundSterlingProps extends IconProps {
  type?: "stroke";
}

export const BadgePoundSterling: IconComponent<BadgePoundSterlingProps> =
  React.forwardRef<SVGSVGElement, BadgePoundSterlingProps>(
    function BadgePoundSterling(
      ...
      console.error(`BadgePoundSterling doesn't support ${type}`);
      return null;
    },
  );
...
BadgePoundSterling.metadata = {
  ...
  description: "BadgePoundSterling icon from stroke/shopping category",
  type: ["stroke", "icon"],
} as IconMetadata;
