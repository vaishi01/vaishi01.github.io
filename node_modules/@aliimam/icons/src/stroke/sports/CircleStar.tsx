...
interface CircleStarProps extends IconProps {
  type?: "stroke";
}

export const CircleStar: IconComponent<CircleStarProps> = React.forwardRef<
  SVGSVGElement,
  CircleStarProps
>(function CircleStar(
  {
