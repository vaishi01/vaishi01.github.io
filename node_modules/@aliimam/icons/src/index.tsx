...
export * from "./stroke/photography";
export * from "./stroke/science";
export * from "./stroke/seasons";
export * from "./stroke/security";
export * from "./stroke/shapes";
export * from "./stroke/shopping";
export * from "./stroke/social";
export * from "./stroke/sports";
export * from "./stroke/sustainability";
export * from "./stroke/timeCalendar";
export * from "./stroke/tools";
export * from "./stroke/transportation";
export * from "./stroke/travel";
export * from "./stroke/weather";
