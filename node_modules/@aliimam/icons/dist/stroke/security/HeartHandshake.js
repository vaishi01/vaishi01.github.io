...
export const HeartHandshake = React.forwardRef(function HeartHandshake({ color = "currentColor", fill, size = 24, strokeWidth, strokeLinecap, strokeLinejoin, strokeDasharray, opacity, className, type = "stroke", ...props }, forwardedRef) {
    ...
    console.error(`HeartHandshake doesn't support ${type}`);
    return null;
});
HeartHandshake.displayName = "HeartHandshake";
HeartHandshake.metadata = {
    name: "HeartHandshake",
    category: "stroke/security",
    tags: ["heart", "handshake", "icon"],
    description: "HeartHandshake icon from stroke/security category",
    type: ["stroke", "icon"],
};
