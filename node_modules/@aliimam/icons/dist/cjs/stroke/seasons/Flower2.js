...
exports.Flower2 = React.forwardRef(function Flower2({ color = "currentColor", fill, size = 24, strokeWidth, strokeLinecap, strokeLinejoin, strokeDasharray, opacity, className, type = "stroke", ...props }, forwardedRef) {
    ...
    console.error(`Flower2 doesn't support ${type}`);
    return null;
});
exports.Flower2.displayName = "Flower2";
exports.Flower2.metadata = {
    name: "Flower2",
    category: "stroke/seasons",
    tags: ["flower", "icon"],
    description: "Flower2 icon from stroke/seasons category",
    type: ["stroke", "icon"],
};
exports.default = exports.Flower2;
