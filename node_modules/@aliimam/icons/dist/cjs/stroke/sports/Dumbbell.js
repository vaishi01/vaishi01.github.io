...
exports.Dumbbell = React.forwardRef(function Dumbbell({ color = "currentColor", fill, size = 24, strokeWidth, strokeLinecap, strokeLinejoin, strokeDasharray, opacity, className, type = "stroke", ...props }, forwardedRef) {
    ...
    console.error(`Dumbbell doesn't support ${type}`);
    return null;
});
exports.Dumbbell.displayName = "Dumbbell";
exports.Dumbbell.metadata = {
    name: "Dumbbell",
    category: "stroke/sports",
    tags: ["dumbbell", "icon"],
    description: "Dumbbell icon from stroke/sports category",
    type: ["stroke", "icon"],
};
exports.default = exports.Dumbbell;
