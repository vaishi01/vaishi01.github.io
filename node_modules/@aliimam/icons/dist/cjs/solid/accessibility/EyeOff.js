...
exports.EyeOff = React.forwardRef(function EyeOff({ color = "currentColor", fill, size = 24, strokeWidth, strokeLinecap, strokeLinejoin, strokeDasharray, opacity, className, type = "stroke", ...props }, forwardedRef) {
    ...
    if (type === "stroke") {
        return ((0, jsx_runtime_1.jsxs)("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", className: className, strokeWidth: strokeWidth, strokeLinecap: strokeLinecap, strokeLinejoin: strokeLinejoin, strokeDasharray: strokeDasharray, opacity: opacity, ...props, ref: forwardedRef, children: [(0, jsx_runtime_1.jsx)("path", { d: "M10.733 5.076C13.062 4.798 15.419 5.291 17.442 6.478 19.465 7.665 21.044 9.482 21.938 11.651 22.021 11.876 22.021 12.123 21.938 12.347 21.57 13.238 21.085 14.076 20.494 14.837M14.084 14.158C13.518 14.705 12.76 15.007 11.974 15 11.187 14.993 10.435 14.678 9.878 14.122 9.322 13.565 9.007 12.813 9 12.026 8.993 11.24 9.295 10.482 9.842 9.916", stroke: color, strokeLinecap: "round", strokeLinejoin: "round" }), (0, jsx_runtime_1.jsx)("path", { d: "M17.479 17.499C16.153 18.285 14.673 18.776 13.139 18.939 11.606 19.103 10.056 18.935 8.594 18.446 7.131 17.957 5.791 17.16 4.664 16.108 3.537 15.056 2.65 13.773 2.062 12.348 1.979 12.124 1.979 11.877 2.062 11.652 2.949 9.502 4.509 7.697 6.508 6.509M2 2 22 22", stroke: color, strokeLinecap: "round", strokeLinejoin: "round" })] }));
    }
    if (type === "stroke") {
